...
export const useDatabase = () => {
    const [localReady, setLocalReady] = useState(isGlobalReady);
    const [localError, setLocalError] = useState<Error | null>(globalError);

    useEffect(() => {
        // グローバル状態の変更を購読
        const updateLocal = () => {
            setLocalReady(isGlobalReady);
        ...
        // 初期化がまだの場合は開始
        if (!globalDb && !initializationPromise) {
